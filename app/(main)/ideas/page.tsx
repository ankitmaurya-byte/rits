            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="mt-2 text-xs" style={{ color: "var(--mute)" }}>
                  Leave the title blank and the first description line becomes the title. Line breaks are preserved.
                </p>
              </div>
            ...
            <div className="flex-1 flex flex-col">
              <div className="flex items-start justify-between mb-4 gap-4">
                ...
                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
                  ...
                  <button
                    onClick={async () => {
                      const confirmed = await confirm({ title: "Delete idea?", description: "This idea will be removed permanently.", confirmLabel: "Delete", variant: "destructive" });
                      if (!confirmed) return;
